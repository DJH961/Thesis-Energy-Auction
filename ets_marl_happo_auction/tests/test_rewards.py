...
def test_collateral_cost_logged_matches_formula():
    ...
    auction_actions[:, 1] = 0.1     # q1
    auction_actions[:, 2] = 80.0    # p2
    auction_actions[:, 3] = 0.1     # q2
    auction_actions[:, 4] = 80.0    # p3
    auction_actions[:, 5] = 0.1     # q3
    ...
    auction_actions[0, 1] = 0.67
    auction_actions[0, 2] = 260.0
    auction_actions[0, 3] = 0.67
    auction_actions[0, 4] = 260.0
    auction_actions[0, 5] = 0.67
