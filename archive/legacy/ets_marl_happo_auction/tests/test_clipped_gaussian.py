...
def test_epsilon_greedy_auction(sample_config):
    ...
    agent = PPOAgent(
        ...
        auction_action_low=np.array([40.0, 0.3, 40.0, 0.3, 40.0, 0.3, 0.0, -1, -1, -1], dtype=np.float32),
        auction_action_high=np.array([120.0, 1.3, 120.0, 1.3, 120.0, 1.3, 0.10, 1, 1, 1], dtype=np.float32),
