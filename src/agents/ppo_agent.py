...
OBS1_EMISSIONS_IDX = 9        # Phase-1 obs dim 9: emissions / 10.0 (Mt)
...
class PPOAgent:
    ...
    def __init__(self, agent_id, obs_dim_phase1, obs_dim_phase2,
        ...
        # WTP-anchored exploration parameters (Option D: escape floor-price trap)
        ...
        self._wtp_mac = float(config.get("mac", {}).get("mac_eur_per_tco2", 48.0))
        ...
        if not deterministic and epsilon > 0.0 and np.random.random() < epsilon:
            with torch.no_grad():
                ...
                if self.exploration_mode == "uniform":
                    ...
                    # WTP-anchored exploration (Option D): anchor exploration
    ...
    def compute_gae(self, last_value: float = 0.0):
        ...
        v7.6/v8.3: Batch normalization of rewards inside GAE.
