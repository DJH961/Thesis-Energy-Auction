...
|--------|-----------|--------|
| [ets_marl_happo_current](ets_marl_happo_current) | **The main, current version (v6.3).** Uses PPO/HAPPO agents, 8 learning + 8 bot companies, hidden burn-in warm-start, 5 technologies, unified financial envelopes with capex throughput caps, real EU deployment delays, w_green reward weighting, and inflation-indexed penalties/costs. This is where all active development happens. | **Active** |
