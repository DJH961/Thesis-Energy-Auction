...
|--------|-----------|--------|
| [ets_marl_happo_current](ets_marl_happo_current) | **The main, current version.** Uses PPO/HAPPO agents, 8 companies, 5 technologies. This is where all active development happens. | **Active** |
