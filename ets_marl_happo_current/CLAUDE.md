...
ETS MARL (v7.8.0) — a multi-agent reinforcement learning simulation of the EU Emissions Trading System. 8 learning agents (PPO/HAPPO) and up to 8 heuristic bots compete in a carbon allowance market over 12-year episodes. Agents bid in uniform-price auctions, trade on a secondary market, and invest in renewable energy capacity. This is a PhD thesis project.
