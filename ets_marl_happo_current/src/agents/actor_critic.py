...
class ValueNetwork(nn.Module):
    """V(s) for PPO. Three hidden layers: input→h1→ReLU→h2→ReLU→h3→ReLU→1.
    Layer sizes taper: h1=hidden_size, h2=hidden_size//2, h3=hidden_size//4.
    LayerNorm on first hidden layer stabilises the wide centralized-critic input."""
